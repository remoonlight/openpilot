...
def create_lka_steering(packer, frame, acm_lka_hba_cmd, apply_torque, enabled, active, aol):
  ...
  values |= {
    ...
    "ACM_lkaActToi": aol.lat_active,

    "ACM_lkaLaneRecogState": 3 if aol.lka_icon_states else 0,
    "ACM_lkaSymbolState": 3 if aol.lka_icon_states else 0,
