...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LongitudinalControlMode", {PERSISTENT | BACKUP, INT, "0"}},
    ...
    {"ParamsVersion", {PERSISTENT, INT, "0"}},
    ...
    // E2E set speed: 0 = default 105kph/65mph, 1 = use current vehicle speed on SET
    ...
    {"CurvatureDDebugData", {PERSISTENT | BACKUP, BOOL, "0"}},
