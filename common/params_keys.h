...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LongIncrementsEnabled", {PERSISTENT, BOOL, "1"}},
    {"LongIncrementTapStep", {PERSISTENT, INT, "10"}},
    ...
    // iqlink: CP搭子 → IQ.Pilot bridge (BLE-only nav; device WiFi STA unchanged)
    // B3: product default ON (fresh params). Already-persisted 0 stays until user toggles.
    {"IqlinkEnabled", {PERSISTENT, BOOL, "1"}},
    {"IqlinkExclusive", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    {"IqlinkLinkWarn", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    {"IqlinkSsidWhitelist", {PERSISTENT, JSON}},  // legacy; unused by BLE-only path
    {"IqlinkWarnTimeoutS", {PERSISTENT, STRING, "3"}},
    {"IqlinkCancelTimeoutS", {PERSISTENT, STRING, "5"}},
    {"IqlinkHotspotSsid", {PERSISTENT, STRING, "comma-cplink"}},  // legacy
    {"IqlinkPinnedGaodeVersion", {PERSISTENT, STRING}},
    {"IqlinkPinnedCpVersion", {PERSISTENT, STRING}},
    {"IqlinkAggressiveLaneChange", {PERSISTENT, BOOL, "1"}},
    {"IqlinkBlePsk", {PERSISTENT, STRING}},
    // Runtime: 0=off, 1=connecting/bonding/auth, 2=connected (UI BT icon)
    {"IqlinkBleLinkState", {CLEAR_ON_MANAGER_START, INT, "0"}},
    // Runtime: connectable advertise window (pair code UI)
    {"IqlinkBleDiscovering", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    // Runtime: mirror of LinkState==2 (compat for older UI polls)
    {"IqlinkBleConnected", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    // Runtime: BlueZ SoftBus Device1 Connected (UI green per product C; ADV still uses LinkState)
    {"IqlinkBlePeerConnected", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    // Runtime: HMAC/PSK match failed or connecting timeout (UI red while enabled)
    {"IqlinkBlePairFailed", {CLEAR_ON_MANAGER_START, BOOL, "0"}},
    // One-shot: force product cruise defaults (curve pred + ±10) onto already-persisted devices
    {"IqlinkProductCruiseDefaultsV1", {PERSISTENT, BOOL, "0"}},
