...
from iqpilot.system.hardware.base import LPABase, LPAError, LPAProfileNotFoundError, Profile
...
class TiciLPA(LPABase):
  ...
  def __init__(self, interface: Literal["qmi", "at"] = "at", device: str = DEFAULT_DEVICE, baud: int = DEFAULT_BAUD,
    ...
    from iqpilot.system.hardware.tici.hardware import get_device_type
