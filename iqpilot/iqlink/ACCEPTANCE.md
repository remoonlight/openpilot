...
- **TBT / curves:** distance-based slowing + desire; take the stricter of Partner target vs MEB/vision curve cues.
- **Lights:** red/yellow → aggressive decel toward stop; lead has priority; no fake green. With countdown: `remainS==3` still stop; `remainS==1` may release.
